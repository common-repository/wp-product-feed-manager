...
if ( ! class_exists( 'WPPFM_Support_Page' ) ) :
	...
	class WPPFM_Support_Page {
		...
		private function show_your_love_card() {
			...
			$html  = '<div class="wppfm-support-card" id="wppfm-show-your-love-support-card">';
		...
		private function documentation_card() {
			...
			$html  = '<div class="wppfm-support-card" id="wppfm-documentation-support-card">';
...
//
//			$html  = '<div class="wppfm-support-card" id="wppfm-join-our-community-support-card">';
...
//		}
		...
		private function request_a_feature_card() {
			...
			$html  = '<div class="wppfm-support-card" id="wppfm-request-a-feature-support-card">';
