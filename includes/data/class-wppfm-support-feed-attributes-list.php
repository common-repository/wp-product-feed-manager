...
if ( ! class_exists( 'WPPFM_Support_Feed_Attributes_List' ) ) :
	...
	class WPPFM_Support_Feed_Attributes_List {
		 ...
		 */
		public static function get_support_feed_attributes( $mandatory_attributes, $optional_attributes ) {
			$attributes        = array();
			$attribute_counter = 1;
		 ...
		 */
		public static function get_woocommerce_to_promotions_feed_inputs() {
			return new stdClass();
		}
